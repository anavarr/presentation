...
\begin{frame}{Conclusions}
    \begin{itemize}
        \item Although \emph{Quarkus-virtual-threads} outperforms \emph{Quarkus-blocking} in the context of the experiment, it still does not scale to the concurrency of \emph{Quarkus-reactive}.
        \item Memory consumption is especially high for \emph{Quarkus-virtual-threads}.
        \item Virtual threads are not directly responsible for the high memory consumption.
